...
The rest of this is totally optional stuff I did in addition:
2. Remove some noise: 
...
4. Add a **Writing Samples** nav item by creating a couple new files: 
	...
	2. In your GitHub site's root folder (`_username_.github.io`), create a `resume.md` file.
		...
		Note: Writing Samples is just one example. You could make a "Resume" or "Portfolio" one if you prefer! Just change the naming in those two files listed in this step. 
