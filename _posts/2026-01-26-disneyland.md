...
✅ Wait times on the app are useful--especially for temporary closures--but I shouldn't flock to faraway low wait times.
✅ Get familiar with the app & map far in advance of the trip (wait times, dining reservations, mobile ordering, events, and so on). 
...
### 5. Food wish list
1. Jolly Holiday treats + grilled cheese w/tomato soup
2. Little Red Wagon corn dog
3. Maurice's Treats garlic cheesy pretzel bread
4. Some sort of ice cream thing
5. Churro
6. Kettle corn (daughter's #1)
