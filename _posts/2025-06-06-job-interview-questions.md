...
I can handle expectations for high impact x high autonomy OR average impact x low autonomy. What's very hard for me is when someone expects high impact x low autonomy in a docs system that is admittedly failing (in a successful, working system, I'd be fine with it). I guess I'm learning this about myself--I've always loved fixing things? As a senior writer with the types of experiences (and customer successes) I've had, I don't do well with arbitrary decision-making gatekeeping around docs. There's too much I'll want to do and I'll be frustrated if I'm told I can't do them for arbitrary, hypothetical, or imaginary reasons. Stashing these questions for the future. 